...
For reference, HM3K was build and tested with the following:
1. Print settings: Voron settings found in the [Voron Sourcing Guide](https://docs.vorondesign.com/sourcing.html)
